      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center animate-fade-in">
          ...
          <Button 
            ...
            size="lg" 
            className="bg-white text-primary hover:bg-gray-100 px-12 py-8 text-xl font-bold rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
          >
